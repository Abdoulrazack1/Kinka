...
const series = [
  ...
  { nom: 'Bleach',                 auteur: 'Tite Kubo',            editeur: 'Glénat',     categorie: 'Shônen', tomes: 74,  prix: 6.90, dateDebut: 2003, image: '/asset/image/banniere_glenat.webp', tags: ['Shinigami','Combat','Surnaturel'],          description: 'Ichigo Kurosaki obtient les pouvoirs de Shinigami et protège les humains des Hollows.' },
  ...
  { nom: 'Hunter x Hunter',        auteur: 'Yoshihiro Togashi',    editeur: 'Kana',       categorie: 'Shônen', tomes: 37,  prix: 6.85, dateDebut: 2000, image: '/asset/image/banniere_kana.jpg', tags: ['Aventure','Stratégie','Combat'],          description: 'Gon Freecss part à la recherche de son père, un Hunter légendaire, en s\u2019inscrivant à l\u2019examen des Hunters.' },
  { nom: 'Fairy Tail',             auteur: 'Hiro Mashima',         editeur: 'Pika',       categorie: 'Shônen', tomes: 63,  prix: 6.95, dateDebut: 2008, image: '/asset/image/banniere_pika.jpg', tags: ['Magie','Aventure','Guilde'],              description: 'Lucy Heartfilia rejoint la guilde de mages Fairy Tail et vit des aventures épiques avec Natsu et ses amis.' },
  { nom: 'Fullmetal Alchemist',    auteur: 'Hiromu Arakawa',       editeur: 'Kurokawa',   categorie: 'Shônen', tomes: 27,  prix: 7.10, dateDebut: 2005, image: '/asset/image/banniere_jjk.png', tags: ['Alchimie','Frères','Aventure'],            description: 'Edward et Alphonse Elric, alchimistes, cherchent la Pierre Philosophale pour récupérer leurs corps.' },
  ...
  { nom: 'Monster',                auteur: 'Naoki Urasawa',        editeur: 'Kana',       categorie: 'Seinen', tomes: 18,  prix: 12.50, dateDebut: 2010, image: '/asset/image/banniere_kana.jpg', tags: ['Thriller','Psychologique','Médical'],     description: 'Le Dr Tenma sauve la vie d\u2019un enfant qui deviendra un tueur en série. Thriller magistral.' },
  ...
  { nom: 'Pluto',                  auteur: 'Naoki Urasawa',        editeur: 'Kana',       categorie: 'Seinen', tomes: 8,   prix: 13.00, dateDebut: 2010, image: '/asset/image/banniere_kana.jpg', tags: ['Robots','Thriller','Philosophique'],     description: 'Adaptation magistrale d\u2019Astro Boy d\u2019Osamu Tezuka. Un thriller sur la guerre entre humains et robots.' },
  ...
  // ═══ SHŌJO ═══════════════════════════════════════════════
  { nom: 'Fruits Basket',          auteur: 'Natsuki Takaya',       editeur: 'Delcourt',   categorie: 'Shôjo',  tomes: 23,  prix: 6.99, dateDebut: 2003, image: '/asset/image/banniere_promo.jpg', tags: ['Romance','Surnaturel','Famille'],            description: 'Tohru Honda emménage dans la maison Soma, dont les membres sont possédés par les esprits des animaux du zodiaque.' },
  { nom: 'Sailor Moon',            auteur: 'Naoko Takeuchi',       editeur: 'Pika',       categorie: 'Shôjo',  tomes: 12,  prix: 8.95, dateDebut: 2012, image: '/asset/image/banniere_pika.jpg', tags: ['Magical Girl','Romance','Classique'],            description: 'Usagi Tsukino se transforme en Sailor Moon pour combattre les forces du mal aux côtés des autres guerrières.' },
  { nom: 'Nana',                   auteur: 'Ai Yazawa',            editeur: 'Delcourt',   categorie: 'Shôjo',  tomes: 21,  prix: 6.99, dateDebut: 2002, image: '/asset/image/banniere_promo.jpg', tags: ['Drame','Musique','Amitié'],                  description: 'Deux jeunes femmes nommées Nana se rencontrent dans le train pour Tokyo et deviennent colocataires.' },
  { nom: 'Cardcaptor Sakura',      auteur: 'CLAMP',                editeur: 'Pika',       categorie: 'Shôjo',  tomes: 12,  prix: 7.95, dateDebut: 2012, image: '/asset/image/banniere_pika.jpg', tags: ['Magical Girl','Romance','Aventure'],             description: 'Sakura libère par accident les cartes magiques de Clow et doit toutes les recapturer.' },
  { nom: 'Kimi ni Todoke',         auteur: 'Karuho Shiina',        editeur: 'Kana',       categorie: 'Shôjo',  tomes: 30,  prix: 6.85, dateDebut: 2008, image: '/asset/image/banniere_kana.jpg', tags: ['Romance','École','Slice of Life'],         description: 'Sawako, surnommée \u00ab Sadako \u00bb, peine à se faire des amis. Sa rencontre avec Kazehaya change tout.' },
  { nom: 'Lovely Complex',         auteur: 'Aya Nakahara',         editeur: 'Delcourt',   categorie: 'Shôjo',  tomes: 17,  prix: 6.99, dateDebut: 2007, image: '/asset/image/banniere_promo.jpg', tags: ['Romance','Comédie','Différence'],          description: 'Risa, grande, et Otani, petit, forment le duo comique du lycée. Et si l\u2019amour leur tombait dessus ?' },

  // ═══ JOSEI ═══════════════════════════════════════════════
  { nom: 'Chihayafuru',            auteur: 'Yuki Suetsugu',        editeur: 'Pika',       categorie: 'Josei',  tomes: 50,  prix: 6.95, dateDebut: 2014, image: '/asset/image/banniere_pika.jpg', tags: ['Karuta','Compétition','Romance'],         description: 'Chihaya rêve de devenir Reine du karuta, ce jeu de cartes traditionnel japonais.' },
  ...
  { nom: 'Honey and Clover',       auteur: 'Chica Umino',          editeur: 'Kana',       categorie: 'Josei',  tomes: 10,  prix: 7.45, dateDebut: 2007, image: '/asset/image/banniere_kana.jpg', tags: ['Romance','École d\'art','Slice of Life'], description: 'Cinq étudiants en art partagent leur quotidien dans une vieille maison étudiante de Tokyo.' },

  // ═══ COFFRETS ═════════════════════════════════════════════
  { nom: 'Coffret One Piece - East Blue', auteur: 'Eiichiro Oda',  editeur: 'Glénat',     categorie: 'Coffret', tomes: 1,  prix: 89.00, dateDebut: 2022, image: '/asset/image/banniere_east_blue.jpg', tags: ['Coffret','Collector'], description: 'Coffret regroupant les 12 premiers tomes de One Piece dans une édition collector.' },
  ...
  // ═══ KODOMO ═══════════════════════════════════════════════
  { nom: 'Doraemon',               auteur: 'Fujiko F. Fujio',      editeur: 'Kana',       categorie: 'Kodomo', tomes: 45,  prix: 6.85, dateDebut: 2010, image: '/asset/image/banniere_kana.jpg', tags: ['Robot','Famille','Aventure'],            description: 'Doraemon, un chat-robot venu du futur, aide le jeune Nobita avec ses gadgets extraordinaires.' },
  { nom: 'Yotsuba',                auteur: 'Kiyohiko Azuma',       editeur: 'Kurokawa',   categorie: 'Kodomo', tomes: 16,  prix: 8.50, dateDebut: 2007, image: '/asset/image/banniere_kioon.png', tags: ['Slice of Life','Enfance','Humour'],     description: 'Yotsuba, petite fille pleine d\u2019énergie, découvre le monde quotidien avec un émerveillement contagieux.' },

  // ═══ SHŌNEN — séries longues ═════════════════════════════
  { nom: 'Detective Conan',        auteur: 'Gosho Aoyama',         editeur: 'Kana',       categorie: 'Shônen', tomes: 105, prix: 6.85, dateDebut: 1996, image: '/asset/image/banniere_kana.jpg', tags: ['Mystère','Détective','Enquête'],          description: 'Shinichi Kudo, jeune détective transformé en enfant, résout des affaires sous l\u2019identité de Conan Edogawa.' },
  { nom: 'Gintama',                auteur: 'Hideaki Sorachi',      editeur: 'Kana',       categorie: 'Shônen', tomes: 77,  prix: 6.85, dateDebut: 2007, image: '/asset/image/banniere_kana.jpg', tags: ['Comédie','Samouraï','Science-fiction'],   description: 'Dans un Japon de l\u2019Edo envahi par des aliens, Gintoki et son équipe acceptent toutes les missions.' },
  { nom: 'Reborn!',                auteur: 'Akira Amano',          editeur: 'Glénat',     categorie: 'Shônen', tomes: 42,  prix: 6.90, dateDebut: 2008, image: '/asset/image/banniere_glenat.webp', tags: ['Mafia','Action','Comédie'],         description: 'Tsuna, lycéen lambda, est désigné comme futur parrain d\u2019une famille mafieuse italienne par un bébé tueur à gages.' },
  { nom: 'Yu Yu Hakusho',          auteur: 'Yoshihiro Togashi',    editeur: 'Kana',       categorie: 'Shônen', tomes: 19,  prix: 6.85, dateDebut: 2008, image: '/asset/image/banniere_kana.jpg', tags: ['Surnaturel','Combat','Démons'],            description: 'Yusuke Urameshi devient détective spirituel après être mort en sauvant un enfant.' },
  ...
  { nom: 'Nanatsu no Taizai',      auteur: 'Nakaba Suzuki',        editeur: 'Pika',       categorie: 'Shônen', tomes: 41,  prix: 6.95, dateDebut: 2014, image: '/asset/image/banniere_pika.jpg', tags: ['Chevaliers','Magie','Aventure'],         description: 'La princesse Élisabeth recherche les Seven Deadly Sins pour libérer son royaume.' },
  { nom: 'Black Butler',           auteur: 'Yana Toboso',          editeur: 'Kana',       categorie: 'Shônen', tomes: 33,  prix: 7.45, dateDebut: 2009, image: '/asset/image/banniere_kana.jpg', tags: ['Démons','Mystère','Victorien'],            description: 'Ciel Phantomhive, jeune comte britannique, est servi par Sebastian, un majordome démoniaque.' },
  { nom: 'D.Gray-man',             auteur: 'Katsura Hoshino',      editeur: 'Glénat',     categorie: 'Shônen', tomes: 27,  prix: 6.90, dateDebut: 2007, image: '/asset/image/banniere_glenat.webp', tags: ['Exorcistes','Combat','Surnaturel'],   description: 'Allen Walker, exorciste, combat les Akumas créés par le Comte Millénaire.' },
  ...
  { nom: 'Diamond no Ace',         auteur: 'Yuji Terajima',        editeur: 'Glénat',     categorie: 'Shônen', tomes: 47,  prix: 6.90, dateDebut: 2018, image: '/asset/image/banniere_glenat.webp', tags: ['Baseball','Sport','Lycée'],         description: 'Eijun Sawamura, lanceur prodige, rejoint l\u2019équipe d\u2019élite de Seido.' },
  { nom: 'Slam Dunk',              auteur: 'Takehiko Inoue',       editeur: 'Kana',       categorie: 'Shônen', tomes: 31,  prix: 6.85, dateDebut: 1995, image: '/asset/image/banniere_kana.jpg', tags: ['Basket','Sport','Classique'],            description: 'Hanamichi Sakuragi, délinquant, intègre le club de basket pour impressionner Haruko. Classique absolu du sport-manga.' },
  { nom: 'Captain Tsubasa',        auteur: 'Yōichi Takahashi',     editeur: 'Glénat',     categorie: 'Shônen', tomes: 37,  prix: 7.20, dateDebut: 1999, image: '/asset/image/banniere_glenat.webp', tags: ['Football','Sport','Classique'],       description: 'Tsubasa Ozora, jeune prodige du foot, vise la Coupe du Monde.' },
  { nom: 'Ranma ½',                auteur: 'Rumiko Takahashi',     editeur: 'Glénat',     categorie: 'Shônen', tomes: 38,  prix: 6.90, dateDebut: 1995, image: '/asset/image/banniere_glenat.webp', tags: ['Comédie','Romance','Arts martiaux'],   description: 'Ranma se transforme en fille au contact de l\u2019eau froide. Promis à Akane, leur quotidien est chaotique.' },
  { nom: 'InuYasha',               auteur: 'Rumiko Takahashi',     editeur: 'Kana',       categorie: 'Shônen', tomes: 56,  prix: 6.85, dateDebut: 2002, image: '/asset/image/banniere_kana.jpg', tags: ['Voyage temporel','Démons','Romance'],     description: 'Kagome, lycéenne moderne, traverse un puits magique vers le Japon féodal et rencontre InuYasha le demi-démon.' },
  { nom: 'Saint Seiya',            auteur: 'Masami Kurumada',      editeur: 'Kana',       categorie: 'Shônen', tomes: 28,  prix: 6.85, dateDebut: 1999, image: '/asset/image/banniere_kana.jpg', tags: ['Mythologie','Combat','Classique'],         description: 'Seiya et les Chevaliers du Zodiaque protègent Athéna. Classique du shōnen des années 80.' },
  ...
  { nom: 'Real',                   auteur: 'Takehiko Inoue',       editeur: 'Kana',       categorie: 'Seinen', tomes: 15,  prix: 8.50, dateDebut: 2009, image: '/asset/image/banniere_kana.jpg', tags: ['Handicap','Basket','Drame'],              description: 'Trois jeunes hommes, dont un en fauteuil roulant, font face à leurs limites par le basket.' },
  { nom: 'Sanctuary',              auteur: 'Ryoichi Ikegami',      editeur: 'Glénat',     categorie: 'Seinen', tomes: 12,  prix: 9.50, dateDebut: 2002, image: '/asset/image/banniere_glenat.webp', tags: ['Politique','Yakuza','Thriller'],     description: 'Deux survivants des Killing Fields cambodgiens veulent réformer le Japon : l\u2019un par la politique, l\u2019autre par le crime.' },
  ...
  { nom: 'Le Sommet des Dieux',    auteur: 'Jirō Taniguchi',       editeur: 'Kana',       categorie: 'Seinen', tomes: 5,   prix: 14.50, dateDebut: 2004, image: '/asset/image/banniere_kana.jpg', tags: ['Alpinisme','Aventure','Mystère'],         description: 'Un journaliste enquête sur la disparition de Mallory à l\u2019Everest et croise le chemin d\u2019un alpiniste mystérieux.' },
  ...
  { nom: 'Bakuman.',               auteur: 'Tsugumi Ohba',         editeur: 'Kana',       categorie: 'Shônen', tomes: 20,  prix: 6.85, dateDebut: 2010, image: '/asset/image/banniere_kana.jpg', tags: ['Mangaka','Métier','Rêves'],              description: 'Mashiro et Takagi rêvent de devenir mangakas et de voir leur œuvre adaptée en anime.' },
  { nom: 'Death Note',             auteur: 'Tsugumi Ohba',         editeur: 'Kana',       categorie: 'Shônen', tomes: 12,  prix: 6.85, dateDebut: 2007, image: '/asset/image/banniere_kana.jpg', tags: ['Thriller','Surnaturel','Psychologique'], description: 'Light Yagami trouve un cahier qui tue toute personne dont le nom y est inscrit.' },
  ...
  // ═══ SHŌJO — additions ═══════════════════════════════════
  { nom: 'Ouran High School Host Club', auteur: 'Bisco Hatori',    editeur: 'Pika',       categorie: 'Shôjo',  tomes: 18,  prix: 7.90, dateDebut: 2009, image: '/asset/image/banniere_pika.jpg', tags: ['Romance','Comédie','Lycée'],          description: 'Haruhi, étudiante boursière, est prise pour un garçon et intègre le club d\u2019hôtes de son lycée.' },
  ...
  { nom: 'Maid Sama!',             auteur: 'Hiro Fujiwara',        editeur: 'Pika',       categorie: 'Shôjo',  tomes: 18,  prix: 6.95, dateDebut: 2011, image: '/asset/image/banniere_pika.jpg', tags: ['Romance','Lycée','Comédie'],              description: 'Misaki, présidente sévère de son lycée, travaille en secret comme serveuse maid pour aider sa famille.' },
  ...
  { nom: 'Kaichou wa Maid-sama',   auteur: 'Hiro Fujiwara',        editeur: 'Pika',       categorie: 'Shôjo',  tomes: 18,  prix: 6.95, dateDebut: 2011, image: '/asset/image/banniere_pika.jpg', tags: ['Romance','Comédie','Lycée'],          description: 'Variante alternative du titre Maid Sama!' },
  { nom: 'Special A',              auteur: 'Maki Minami',          editeur: 'Soleil Manga', categorie: 'Shôjo', tomes: 17, prix: 6.99, dateDebut: 2009, image: '/asset/image/banniere_promo.jpg', tags: ['Romance','Compétition','Élite'],         description: 'Hikari et Kei, deux génies, se disputent la première place dans une école d\u2019élite.' },
  { nom: 'Akatsuki no Yona',       auteur: 'Mizuho Kusanagi',      editeur: 'Pika',       categorie: 'Shôjo',  tomes: 39,  prix: 6.95, dateDebut: 2014, image: '/asset/image/banniere_pika.jpg', tags: ['Aventure','Royauté','Dragons'],            description: 'Yona, princesse exilée, part à la recherche des Dragons légendaires pour reconquérir son royaume.' },

  // ═══ JOSEI — additions ═══════════════════════════════════
  { nom: 'Princess Jellyfish',     auteur: 'Akiko Higashimura',    editeur: 'Delcourt',   categorie: 'Josei',  tomes: 17,  prix: 7.99, dateDebut: 2017, image: '/asset/image/banniere_promo.jpg', tags: ['Comédie','Otaku','Mode'],                  description: 'Tsukimi et ses colocataires otaku voient leur tranquillité menacée par un beau jeune homme... travesti.' },
  { nom: 'Le Carnet de l\'Apothicaire', auteur: 'Natsu Hyuuga',    editeur: 'Ki-oon',     categorie: 'Josei',  tomes: 12,  prix: 7.65, dateDebut: 2021, image: '/asset/image/banniere_jjk.png', tags: ['Cour impériale','Mystère','Intrigue'],   description: 'Maomao, jeune apothicaire perspicace, résout les mystères du palais impérial dans une Chine fantasmée.' },
  ...
  // ═══ KODOMO — additions ═══════════════════════════════════
  { nom: 'Pokémon Adventures',     auteur: 'Hidenori Kusaka',      editeur: 'Glénat',     categorie: 'Kodomo', tomes: 30,  prix: 6.95, dateDebut: 2011, image: '/asset/image/banniere_glenat.webp', tags: ['Pokémon','Aventure','Famille'],     description: 'Adaptation manga officielle des jeux Pokémon, suivant Red, Blue et leurs successeurs.' },
  ...
  { nom: 'Kochikame',              auteur: 'Osamu Akimoto',        editeur: 'Kana',       categorie: 'Shônen', tomes: 100, prix: 6.85, dateDebut: 2002, image: '/asset/image/banniere_kana.jpg', tags: ['Comédie','Police','Quotidien'],           description: 'Le quotidien hilarant de l\u2019officier Kankichi Ryotsu, flic le plus déjanté du Japon.' },
  ...
  { nom: 'GTO',                    auteur: 'Tōru Fujisawa',        editeur: 'Pika',       categorie: 'Shônen', tomes: 25,  prix: 6.95, dateDebut: 2008, image: '/asset/image/banniere_pika.jpg', tags: ['École','Comédie','Délinquant'],            description: 'Eikichi Onizuka, ex-délinquant devenu prof, gère sa classe à sa façon.' },
  ...
  { nom: 'Gunnm',                  auteur: 'Yukito Kishiro',       editeur: 'Glénat',     categorie: 'Seinen', tomes: 9,   prix: 8.50, dateDebut: 1995, image: '/asset/image/banniere_glenat.webp', tags: ['Cyberpunk','Action','Cult'],         description: 'Une cyborg amnésique se réveille dans la décharge sous une mégalopole flottante.' },
  { nom: 'Kenshin le Vagabond',    auteur: 'Nobuhiro Watsuki',     editeur: 'Glénat',     categorie: 'Shônen', tomes: 28,  prix: 6.90, dateDebut: 1998, image: '/asset/image/banniere_glenat.webp', tags: ['Samouraï','Histoire','Romance'],     description: 'Kenshin Himura, ex-assassin de l\u2019ère Meiji, vit en pacifiste avec une lame inversée.' },
  { nom: 'Initial D',              auteur: 'Shūichi Shigeno',      editeur: 'Glénat',     categorie: 'Seinen', tomes: 48,  prix: 7.20, dateDebut: 2007, image: '/asset/image/banniere_glenat.webp', tags: ['Course','Voitures','Tofu'],           description: 'Takumi, livreur de tofu, devient un pilote légendaire en dévalant les cols la nuit.' },
  { nom: 'Yakitate!! Japan',       auteur: 'Takashi Hashiguchi',   editeur: 'Delcourt',   categorie: 'Shônen', tomes: 26,  prix: 6.99, dateDebut: 2007, image: '/asset/image/banniere_promo.jpg', tags: ['Cuisine','Compétition','Comédie'],      description: 'Azuma Kazuma rêve de créer un pain japonais qui rivalise avec les pains français.' },
  { nom: 'Bakuman',                auteur: 'Tsugumi Ohba',         editeur: 'Kana',       categorie: 'Shônen', tomes: 20,  prix: 6.85, dateDebut: 2010, image: '/asset/image/banniere_kana.jpg', tags: ['Mangaka','Métier','Suite'],              description: 'Variante orthographe de Bakuman.' },
];
