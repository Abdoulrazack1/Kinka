...
function afficherImage(produit) {                                    // remplit l'image principale
    ...
    img.src = produit.image || '/asset/image/One-Piece-Edition-originale-Tome-105.jpg'; // image ou fallback
    img.alt = produit.titre;                                        // texte alternatif
    img.onerror = function() { this.src = '/asset/image/One-Piece-Edition-originale-Tome-105.jpg'; }; // fallback si erreur de chargement
}
