...
{id:'golden-kamuy-30',titre:'Golden Kamuy - Tome 30',serie:'Golden Kamuy',tome:30,auteur:'Satoru Noda',editeur:'Ki-oon',collection:'Seinen Manga',categorie:'Seinen',etat:'neuf',langue:'Français',prix:8.50,pages:192,format:'11.5 × 18 cm',dateParution:'15 nov. 2023',ean:'9791032714508',image:'https://covers.openlibrary.org/b/isbn/9791032714508-L.jpg',description:'La chasse à l\'or aïnou atteint son apogée ! Sugimoto l\'Immortel et Asirpa traversent Hokkaïdo dans une aventure qui mêle survie, cuisine traditionnelle et mystère.',tags:['Histoire','Survie','Aventure'],note:4.7,stock:6,nouveaute:false,promo:true,prixPromo:6.90,coupDeCoeur:false,bestseller:false},

{id:'blame-1',titre:'BLAME! - Tome 1',serie:'BLAME!',tome:1,auteur:'Tsutomu Nihei',editeur:'Glénat',collection:'Seinen Manga',categorie:'Seinen',etat:'neuf',langue:'Français',prix:12.90,pages:416,format:'14.8 × 21 cm',dateParution:'2019',ean:'9782344031957',image:'https://covers.openlibrary.org/b/isbn/9782344031957-L.jpg',description:'Dans un futur dystopique, Killy erre dans une méga-structure tentaculaire à la recherche d\'humains porteurs d\'un génome particulier. Un chef-d\'œuvre du cyberpunk.',tags:['Cyberpunk','Science-fiction','Atmosphérique'],note:4.7,stock:4,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},
...
{id:'naruto-shippuden-1',titre:'Naruto - Tome 28',serie:'Naruto',tome:28,auteur:'Masashi Kishimoto',editeur:'Kana',collection:'Shōnen Manga',categorie:'Shônen',etat:'occasion',etatDetail:'tres-bon',langue:'Français',prix:3.50,pages:192,format:'11.5 × 18 cm',dateParution:'2006',ean:'9782871295174',image:'https://covers.openlibrary.org/b/isbn/9782871295174-L.jpg',description:'Début de l\'arc Shippuden. Naruto revient au village après 3 ans d\'entraînement avec Jiraiya. Mais Gaara est enlevé par l\'Akatsuki...',tags:['Ninja','Action','Shippuden'],note:4.7,stock:3,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},
...
{id:'berserk-1',titre:'Berserk - Tome 1',serie:'Berserk',tome:1,auteur:'Kentaro Miura',editeur:'Glénat',collection:'Seinen Manga',categorie:'Seinen',etat:'neuf',langue:'Français',prix:9.99,pages:224,format:'11.5 × 18 cm',dateParution:'11 oct. 2000',ean:'9782723433440',image:'https://covers.openlibrary.org/b/isbn/9782723433440-L.jpg',description:'Guts, le mercenaire au glaive gigantesque, combat des démons dans un monde médiéval obscur. L\'introduction au chef-d\'œuvre de Kentaro Miura.',tags:['Dark Fantasy','Action','Classique'],note:5.0,stock:6,nouveaute:false,promo:false,coupDeCoeur:true,bestseller:true},
...
{id:'dragon-ball-z-occ',titre:'Dragon Ball Z - Tome 15',serie:'Dragon Ball',tome:15,auteur:'Akira Toriyama',editeur:'Glénat',collection:'Shōnen Manga',categorie:'Shônen',etat:'occasion',etatDetail:'bon',langue:'Français',prix:2.90,pages:192,format:'11.5 × 18 cm',dateParution:'2002',ean:'9782723488396',image:'https://covers.openlibrary.org/b/isbn/9782723488396-L.jpg',description:'La saga Cell bat son plein. Gohan se révèle être le guerrier le plus puissant de la Terre. Un tome mythique de la saga Dragon Ball Z.',tags:['Action','Combat','Classique'],note:4.8,stock:2,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},

{id:'attack-titan-occ',titre:'L\'Attaque des Titans - Tome 8',serie:'L\'Attaque des Titans',tome:8,auteur:'Hajime Isayama',editeur:'Pika',collection:'Shōnen Manga',categorie:'Shônen',etat:'occasion',etatDetail:'tres-bon',langue:'Français',prix:3.50,pages:192,format:'11.5 × 18 cm',dateParution:'2013',ean:'9782811615079',image:'https://covers.openlibrary.org/b/isbn/9782811615079-L.jpg',description:'Les révélations sur les Titans s\'accumulent. L\'unité de reconnaissance découvre des secrets terrifiants sur les murailles qui protègent l\'humanité.',tags:['Action','Mystère','Survie'],note:4.8,stock:3,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},

{id:'bleach-occ',titre:'Bleach - Tome 45',serie:'Bleach',tome:45,auteur:'Tite Kubo',editeur:'Glénat',collection:'Shōnen Manga',categorie:'Shônen',etat:'occasion',etatDetail:'bon',langue:'Français',prix:2.90,pages:192,format:'11.5 × 18 cm',dateParution:'2011',ean:'9782344007600',image:'https://covers.openlibrary.org/b/isbn/9782344007600-L.jpg',description:'La guerre contre les Arrancar prend une dimension épique. Ichigo pousse ses limites pour protéger ses amis dans des combats qui font trembler les dimensions.',tags:['Action','Shinigami','Combat'],note:4.5,stock:4,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},

{id:'fullmetal-occ',titre:'Fullmetal Alchemist - Tome 20',serie:'Fullmetal Alchemist',tome:20,auteur:'Hiromu Arakawa',editeur:'Kurokawa',collection:'Shōnen Manga',categorie:'Shônen',etat:'occasion',etatDetail:'acceptable',langue:'Français',prix:3.90,pages:192,format:'11.5 × 18 cm',dateParution:'2009',ean:'9782351423905',image:'https://covers.openlibrary.org/b/isbn/9782351423905-L.jpg',description:'Edward et Alphonse se rapprochent de la vérité sur la Porte des Vérités. Les homunculi resserrent leur étau sur Amestris dans cet arc haletant.',tags:['Alchimie','Action','Fraternité'],note:4.9,stock:3,nouveaute:false,promo:false,coupDeCoeur:false,bestseller:false},
...
function buildProductCard(manga, opts = {}) {
    ...
    return `<div class="product-card" data-id="${_esc(manga.id)}" onclick="if(!event.target.closest('.add-to-cart,.card-fav-btn'))window.location.href='/page_detail_produit.html?id=${encodeURIComponent(manga.id)}'">
        <div class="product-image">
            ...
            ${stockLabel}
            <img src="${_esc(manga.image)}" alt="${_esc(manga.titre)}" loading="lazy" onerror="kinkaImgFallback(this,'${_esc(manga.ean || '')}')">
...
// Si l'image locale échoue, on tente Open Library par EAN, puis placeholder
function kinkaImgFallback(img, ean) {
    if (img._fallbackStage === undefined) img._fallbackStage = 0;
    img._fallbackStage++;
    if (img._fallbackStage === 1 && ean && !ean.includes('-C')) {
        // Étape 1 : Open Library par ISBN
        const cleanEan = ean.replace(/-.*$/, '');
        img.src = 'https://covers.openlibrary.org/b/isbn/' + cleanEan + '-L.jpg';
    } else if (img._fallbackStage === 2 && ean && !ean.includes('-C')) {
        // Étape 2 : taille M si L a échoué
        const cleanEan = ean.replace(/-.*$/, '');
        img.src = 'https://covers.openlibrary.org/b/isbn/' + cleanEan + '-M.jpg';
    } else {
        // Étape finale : placeholder générique kinka
        img.onerror = null;
        img.src = 'https://placehold.co/200x290/1a0010/E03B8B?text=KINKA';
