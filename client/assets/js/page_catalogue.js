...
(function _init() {                                                   // IIFE d'initialisation du catalogue
    ...
    async function render() {                                      // charge et affiche les produits filtrés
        ...
        try {                                                      // tentative
            ...
            grid.innerHTML = '<p style="grid-column:1/-1;padding:2rem;opacity:.5">API inaccessible — vérifier que <strong>npm run dev</strong> tourne dans server.</p>'; // message d'aide
        }
    }
